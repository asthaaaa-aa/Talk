...
export default function Chat() {
  ...
  return (
    <>
      ...
      {newChat && <div className="h3-main-heading"> <i class="fi fi-ts-coriander"></i> Lets talk<span className="dot">.</span>  <div className="hero-subheading">Talk is your personal AI mental health companion. It's always there to hear you and make you feel better. Stay strong.</div></div>  }
